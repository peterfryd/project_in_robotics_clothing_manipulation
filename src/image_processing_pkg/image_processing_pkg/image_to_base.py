...
class ImageToBaseNode(Node):
    def __init__(self):
        ...
        H_old = np.array([[9.03593152e-04, -4.26739325e-04, -8.48637901e-01],
                            [-4.15489185e-04, -9.06983303e-04,  4.25934133e-01],
                            [-2.13676908e-05,  2.56016933e-05,  1.00000000e+00]])
        
        H_new = np.array([[ 1.11561131e-03,  1.03953826e-04, -1.13844607e+00],
                        [ 1.22916802e-04, -1.11714405e-03,  2.27883739e-01],
                        [-1.13773951e-05,  4.60959751e-05,  1.00000000e+00]])
