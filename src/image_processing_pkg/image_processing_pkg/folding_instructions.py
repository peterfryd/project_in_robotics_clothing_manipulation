...
def step_2_instructions(cv_image, background, step_1_place):
    ...
    #cv2.imwrite('/home/peter/uni/project_clothing_fresh/image_analysis/images/image_2_instructions.png', image_with_hull)
...
def step_3_instructions(cv_image, background):
   ...
   # cv2.imwrite('/home/peter/uni/project_clothing_fresh/image_analysis/images/image_3_instructions.png', image_with_hull)
...
def step_4_instructions(cv_image, background, step_3_pick, step_3_place):
    ...
    #cv2.imwrite('/home/peter/uni/project_clothing_fresh/image_analysis/images/image_4_instructions.png', image_with_hull)
    return pick_point, place_point
...
def step_5_instructions(cv_image, background, place_point_4):
    ...
    #cv2.imwrite('/home/peter/uni/project_clothing_fresh/image_analysis/images/image_5_instructions.png', image_with_hull)
    return pick_point, place_point
